	...
	public static function get_order_data_to_process($order) {
        ...
        foreach ($order_items as $order_item) {
            $lineItems[] = [
                ...
                "lineComments" => null,
                // "unitCost" => null,
                "unitCost" => !empty($order_item->product_option) &&  !empty( $order_item->product_option->defaultPrice) && !empty($order_item->product_option->defaultPrice->costUSD) ? $order_item->product_option->defaultPrice->costUSD : null,
