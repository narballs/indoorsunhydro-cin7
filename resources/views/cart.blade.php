    					...
    					<div class="row d-flex justify-content-center align-items-center">
   							<div class="col">
        						<div class="table-responsive">
	              								...
	              								<tr id="{{'row_'.$pk_product_id}}" class="quantities">
	                								<th scope="row">
	                  									<div class="d-flex align-items-center">
	                    									<img src="{{$cart['image']}}" class="img-fluid rounded-3" style="width: 120px;" alt="Book">
	                								...
	                								<td class="align-middle">
									                      ...
									                      <i class="fas fa-minus"></i>
									                    	...
									                    	<input id="{{'row_quantity_'.$pk_product_id}}" min="0" name="quantity" value="{{$cart['quantity']}}" type="number"
	                								...
	                								<td class="align-middle">
	                  									<p class="mb-0" style="font-weight: 500;"><span id="subtotal_{{ $pk_product_id }}">${{$cart['price'] * $cart['quantity']  }}</span></p>
	                  									<p class="text-center">
          							...
          							<div><button class="button-cards col w-25" style="float:right" type="submit" class="update_cart" id="update_cart" onclick="update_cart()">Update Cart</button></div>
        						</div>
      						</div>
    					</div>
  					</div>
			...
			<div class="col-md-4 d-flex align-self-stretch mt-5">
          	...
          	<div class="card-body ">
	            <ul class="list-group list-group-flush">
	              	<li
	                class="h-5 list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0 " style="font-weight: 500;">
	                Subtotal
