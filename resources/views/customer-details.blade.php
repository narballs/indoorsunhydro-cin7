                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="fw-bold">
                                        <td colspan="2" class="text-muted pt-0 pb-0 ">{{ $customer->postalAddress1 }}
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr class="fw-bold">
                                        <td colspan="2" class="text-muted pt-0 pb-0 ">{{ $customer->postalAddress2 }}
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-muted  pt-0 pb-0">State :
                                            {{ $customer->postalState }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="text-muted  pt-0 pb-0">Postal Code :
                                            {{ $customer->postalPostCode }}</td>
                                    <tr>
                                        <td colspan="2" class="text-muted  pt-0 pb-0">Postal City :
                                            {{ $customer->postalCity }}</td>
                                    </tr>
                                    </tr>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <span>
                                ...
                                <iclass="bi bi-box-arrow-up-right</i> 
								</span>
		        <hr>
		        <h3 class="h6">
                                    Address </h3>
