		...
		<div class="row">
			...
			<div class="col-lg-3  col-md-6 mb-4 mb-md-0" style="margin-top: 50px;">
				...
				<table class=" text-center">
					<tbody>
						<tr cellspacing="10">
							<td><img class="img-fluid" src="/theme/img/paypal.png"></td>
							<td></td>
							<td><img class="img-fluid" src="/theme/img/discover.png"></td>
							<td></td>
							<td><img class="img-fluid" src="/theme/img/curus.png"></td>
							<td></td>
							<td><img class="img-fluid" src="/theme/img/visa.png"></td>
						</tr>
					</tbody>
				</table>
			</div>
	...
	<div class="container-fluid">
		<div class="row ">
			...
			<div class="col-xl-3 col-lg-3 col-md-0 col-sm-0 col-xs-0 main-page-footer-section footer-section-product">
				...
				<span><img src="/theme/img/map-pin.png" class="img-fluid"></span><span class="ms-2 pra-footer">Los
					Angeles
					Warehouse
					(HQ)</span>
				...
				<span><img src="/theme/img/phone-call.png" class="img-fluid"></span><span class="ms-2 pra-footer">(916)
					281-3090</span>
				<p class="ms-4 ms-4-footer">&nbsp;
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-end ">
				<p class="mt-4">
					Copyright @ LA Garden Supply. All right reserved
				</p>
			</div>
