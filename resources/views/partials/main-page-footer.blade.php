    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-3 main-page-footer-section ">
                ...
                <span><img src="/theme/img/map-pin.png" class="img-fluid"></span><span class="ms-2 fw-bold">San Fernando
                    Valley
                    Warehouse</span>
                <p class="ms-4 ms-4-footer">&nbsp;
            ...
            <div class="col-lg-3 col-md-2 mb-4 mb-md-0 main-page-footer-section">
                <div class="d-flex">
            ...
            <div class="col-lg-3 col-md-3 mb-4 mb-md-0 main-page-footer-section">
