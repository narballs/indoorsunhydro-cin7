      ...
      <div class="row pl-5 pr-5 pb-4 pt-3" style="border: 1px solid rgba(0,0,0,.125);">
             ...
             <div class="col"> 
               ...
               <select class="form-select" id="selected_cat" name="selected_cat" onchange="handleSelectChange('category')">
                  ...
                  @foreach($categories as $category)
                        ...
                        <option value="{{$category->id}}/{{$category->slug}}" {{ isset($category_id) && $category_id == $category->id ? 'selected="selected"' : '' }}>{{ $category->name }}</option>
          ...
          <div class="col"> 
               ...
               <div id="stock">
                  ...
                  ?>             
                  <button class="{{ $stock ? $stock : 'in-stock'  }} {{$danger}}" type="button" id="in-stock" onclick="inStockOutstock('instock'), handleSelectChange()" value="{{$stock}}">{{$text}}</button>
