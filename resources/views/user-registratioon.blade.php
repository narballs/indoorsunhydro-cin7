	...
	<div class="login-reg-panel" style="margin-top:300px;">
		<div class="row">
			<div class="cols">
				<div class="login-info-box text-white">
					<h2 class="text-center justity-conent-center aling-items-center d-flex">Have an account?
					</h2>
					<p class="text-center justity-content-center aling-items-center d-flex" id="account">
		...
		<div class="row">
			<div class="col-md-5">
				...
				<h2 class="text-white address text-center d-none" id="address" style="margin-top:150px">
					Knowing
					where
			...
			<div class="col-md-7 d-none company-address" id="address-form-section">
				...
				<div style="margin-top:20px; background:white; " class="w-100 mt-1">
					<div style="margin-left: -386px" class="mt-1">
						<label for="street_address"><strong class="text-dark">Street Address
							</strong></label>
					</div>
					<div class="mt-3">
					...
					<div class="mt-3">
						<strong class="text-dark" style="margin-left:-327px">Country : </strong>United
						Stated
					</div>
					<div>&nbsp;
					</div>
		...
		<div class="d-none thankyou col-md-10 ms-5 mt-5" id="thanks">
			<h2 class="text-white">Thank you for registering, please allow us sometime to review your
				subbmission.
			</h2>
			<p class="text-white display-6 mt-5">Please continuw bulding you cart while wait for account
				approval
			</p>
			<div id="label-login" class="w-50 text-center"
				style="margin-left: 188px; text-decoration: none; color:#7BC533"><a href="/">Continue
					Shopping</a>
			</div>
		</div>
		...
		<div class="register-info-box text-center">
			...
			<p class="text-white text-center">Your personal data will be used to support your experience
				throughout
				this
				website, to
