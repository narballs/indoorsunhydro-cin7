                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if (!empty($admin_area_for_shipping) && strtolower($admin_area_for_shipping->option_value) == 'yes')
                                            @if (!empty($products_weight) && $products_weight > 150)
                                                <input type="hidden" name="shipment_cost_single" id="shipment_price_heavy_weight" value="{{ $shipping_quote->shipmentCost }}">
                                                <div class="row justify-content-center border-bottom align-items-center py-2">
                                                    ...
                                                    @if (count($admin_selected_shipping_quote) > 0)
                                                        ...
                                                        @if (count($admin_selected_shipping_quote) == 1)
                                                            @foreach ($admin_selected_shipping_quote as $shipping_quote)
                                                                <div class="col-md-9 col-9">
                                                                    <input type="radio" name="shipping_multi_price" id="" value="{{$shipping_quote->shipmentCost}}" checked>
                                                                    <span class="checkout_shipping_heading">{{$shipping_quote->serviceName}}</span>
                                                                </div>
                                                            <div class="col-md-3 col-3 text-right">
                                                                <span class="checkout_shipping_heading">{{number_format($shipping_quote->shipmentCost , 2)}}</span>
                                                            </div>
                                                            <input type="hidden" name="shipment_cost_multiple" id="shipment_price_single" value="{{ $shipping_quote->shipmentCost }}">
                                                            @endforeach
                                                        @else
                                                            @foreach ($admin_selected_shipping_quote as $shipping_quote)
                                                                <div class="col-md-9 col-9">
                                                                    <input type="radio" name="shipping_multi_price" id="" value="{{$shipping_quote->shipmentCost}}">
                                                                    <span class="checkout_shipping_heading">{{$shipping_quote->serviceName}}</span>
                                                                </div>
                                                                <div class="col-md-3 col-3 text-right">
                                                                    <span class="checkout_shipping_heading">{{number_format($shipping_quote->shipmentCost , 2)}}</span>
