	...
	<div class="row">
		<div class="col-md-5 order-md-2 mb-4">
			...
			<div class="col-md-12 row">
				...
				<div class="col-md-6 p-0 ms-1"><img src='theme/img/stripe.png'></div>
			</div>
			...
			<form class="card p-2">
				...
				<div class="row">
					<div class="col-md-7 mb-3">
						...
						<input type="text" class="form-control bg-light" id="cc-expiration" placeholder="Expiration"
							required>
			...
			<form class="needs-validation mt-4 novalidate" action="{{url('order')}}" method="POST">
				...
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control bg-light" name="lastName" placeholder="" value=""
							required>
						<div class="invalid-feedback">
				...
				<div class="mb-3">
					...
					<div class="input-group">
						<input type="text" class="form-control bg-light" name="company"
							placeholder="Enter you company name" required>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control bg-light" name="state" placeholder="Enter State" value=""
							required>
						<div class="invalid-feedback">
							Valid first name is required.
						</div>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						...
						<input type="text" class="form-control bg-light" name="phone" placeholder="Enter your phone"
							value="" required>
						<div class="invalid-feedback">
							Valid first name is required.
						</div>
				...
				<div class="custom-control custom-checkbox">
					...
					<label class="custom-control-label bg-light" for="same-address">Shipping address is the same as my
				...
				<div class="col-md-12 order-md-1">
					...
					<form class="needs-validation mt-4 novalidate" action="{{url('order')}}" method="POST">
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="state">State</label>
								<input type="text" class="form-control bg-light" name="delivery_state"
							...
							<div class="col-md-6 mb-3">
								<label for="zip">Zip</label>
								<input type="text" class="form-control bg-light" name="delivery_zip"
