                ...
                <table class="table table-border">
                    ...
                    <tbody>
                        @php
                            $i =1; 
                        @endphp
                        @if(count($inventory_locations) > 0 )
                        @foreach ($inventory_locations as $inventory_location)
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>{{ $inventory_location->cin7_branch_id }}</td>
                            <td>{{$inventory_location->branch_name}}</td>
                            <td>
                            ...
                            <td>
                                <form action="{{route('inventory-locations.update' , $inventory_location->id)}}" method="post">
                                    @csrf
                                    @method('PUT')
                        ...
                        @else
                        <tr>
                            <td colspan="3">No Inventory Locations found</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
