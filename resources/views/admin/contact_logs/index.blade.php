...
@section('content')
    ...
    <div class="table-wrapper">
        ...
        <div class="card card-body  mt-5">
            <div class="col-md-12 shadow border">
                <table class="table table-border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>{{ !empty($contact_log->user->first_name) ? $contact_log->user->first_name . ' ' .$contact_log->user->last_name : !empty($contact_log->user->email) ? $contact_log->user->email : ''}}</td>
                            <td>{{!empty($contact_log->adminuser->email) ? $contact_log->adminuser->email : $contact_log->adminuser->first_name}}</td>
                            <td>{{$contact_log->action}}</td>
                            <td>{{$contact_log->description}}</td>
                        </tr>
                        @endforeach
                        @else
                        <tr>
            ...
            <div class="row">
                <div class="col-md-10">
                    {{ $contact_logs->links('pagination.custom_pagination') }}
                </div>
            </div>
        </div>
    @stop
