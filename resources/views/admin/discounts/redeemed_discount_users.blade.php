                ...
                <table class="table table-border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>
                                @if (!empty($customer_discount->contact  && $customer_discount->contact->firstName))
                                    {{ $customer_discount->contact->firstName }}
                                @endif
                                @if (!empty($customer_discount->contact  && $customer_discount->contact->lastName))
                                    {{ $customer_discount->contact->lastName }}
                                @endif
                            </td>
                            <td>{{ !empty($customer_discount->contact && $customer_discount->contact->email) ? $customer_discount->contact->email : '' }}</td>
                            <td>{{ $customer_discount->discount_code }}</td>
                            <td>{{ $customer_discount->count() }}</td>
                            <td>{{ucfirst( $customer_discount->discount_variation) }}</td>
                            <td>{{ $customer_discount->discount_variation_value }}</td>
                        </tr>
                        @endforeach
                        @else
                        <tr>
