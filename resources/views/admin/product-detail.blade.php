	...
	<div class="container">
    	...
    	<div class="col-lg-12">
      		...
      		<div class="card mb-4">
        		<div class="card-body">
		            ...
		            <div class="mt-5"><h5><b>Product Options</b></h5></div>
          			<table class="table">
          				<tr>
                				...
                				<td>
                  					<div class="d-flex mb-2">
	                    				<div class="flex-shrink-0">
	                      					<img src="{{$option->image}}" alt="" width="35" class="img-fluid">
	                   					</div>
                  					</div>
                				</td>
      ...
      <!-- Payment -->
      	<div class="card mb-4">
        	<div class="card-body">
	          	<div class="row">
	          		<div class="text-center col-md-12"><h5><b>Pricing</b></h5></div>
	            <table class="table">
	            	<tr>
