...
@section('content')
    ...
    <div class="table-wrapper">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 mobile_heading text-right">
                            <p class="product_heading">
                                <a class="btn btn-primary text-white" href="{{ route('create_ai_question') }}"> Create AI Question</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-body  mt-5">
            <div class="col-md-12 shadow border">
                <table class="table table-border">
                    ...
                    <tbody>
                        ...
                        @foreach ($ai_questions as $ai_question)
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>{!! \Illuminate\Support\Str::limit($ai_question->question, 20) !!}</td>
                            <td>
                                <form action="{{ route('delete_ai_question', $ai_question->id) }}" method="POST" style="display: inline-block;">
                                    <a href="{{ route('edit_ai_question', $ai_question->id) }}" class="btn btn-primary btn-sm text-white">Edit</a>
                                    @csrf
                        ...
                        @else
                        <tr>
                            <td colspan="3">No Ai Questions Found</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
            ...
            <div class="row">
                <div class="col-md-10">
                    {{ $ai_questions->links('pagination.custom_pagination') }}
                </div>
            </div>
        </div>
    @stop
