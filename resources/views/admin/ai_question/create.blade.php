...
@section('content')
    ...
    @endif
    <div>
        <form method="POST" action="{{ route('store_ai_question') }}"  enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="row justify-conntent-between">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="question" rows="8" aria-labelledby="Write Question here ..." id="question" placeholder="Write Question here ..."></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
