...
@section('content_header')
    <div class="row">
        <div class="col-md-6">
            <h1>Add New Shipping Quote Settings</h1>
        </div>
...
@section('content')
    <div>
        <form method="POST" action="{{ route('shipping_quotes.settings.store') }}">
            @csrf
            <div class="row">
                @if ($errors->any())
                    <div class="col-md-12">
                        ...
                        <div class="row justify-conntent-between">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    name="service_code" placeholder="Service Code">
                                </div>
                            </div>    
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    name="carrier_code" placeholder="Carrier Code">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="type">Package Type</label>
                                    <input type="text" class="form-control" id="type" aria-describedby="titleHelp"
                                    name="type" placeholder="Package Type">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="type">Surcharge Type</label>
                                    <select class="form-control" id="type" aria-describedby="titleHelp" name="surcharge_type">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="type">Surcharge Value</label>
                                    <input type="text" class="form-control" name="surcharge_value" id="type" aria-describedby="titleHelp"
                                    name="type" placeholder="Option Name">
                                </div>
                            </div>    
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="type">Status</label>
                                    <select class="form-control" id="type" name="status" aria-describedby="titleHelp">
