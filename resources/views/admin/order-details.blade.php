                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="border-bottom">
                                            <td colspan="4" class="add_colspan"><span class="summary-head mx-2">Added Tax ({{ !empty($order->custom_tax_rate_percent) ? $order->custom_tax_rate_percent : $order->texClasses->rate }}%)</span></td>
