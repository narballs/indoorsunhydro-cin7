                ...
                <table class="table table-border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-info">{{$product_stock_notification_user->status == 0 ? 'Pending' : 'Completed'}}</span></td>
                            <td>
                                <div class="row">
                                    @if ($product_stock_notification_user->status == 0)
                                        <form action="{{route('product_stock_notification' , $product_stock_notification_user->id)}}" method="post">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-primary text-white text-white" onclick="return confirm('Are you sure you want to Notify this Contact?');">Notify</button>
                                        </form>
                                    @else
                                        <a href="#" class="btn btn-success text-white"> Notified</a>
                                    @endif
                                </div>
                            </td>
                        </tr>
