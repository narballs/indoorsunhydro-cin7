...
@section('content')
    <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Suppliers</h2></div>
                    <div class="col-sm-4">
            ...
            <div class="col-sm-2 mb-5">
                <div class="search-box">
                    <a href="{{'order/create'}}"><input type="button" value="Create New Supplier" class="form-control btn btn-primary" placeholder="Create New">
                    </a>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    @foreach($contacts as $key=>$contact)
                        <tr>
                            ...
                            <td>{{$contact->notes}}</td>
                            <td>
                                <a href="{{ url('admin/order-detail/'.$contact->id) }}" class="view" title="" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
