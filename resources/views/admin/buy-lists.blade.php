                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="{{ route('buy-list.destroy', $buylist->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <a href="buy-list/{{ $buylist->id }}" class="view" title=""
                                        data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('buy-list.create', ['id' => $buylist->id]) }}" class="edit"
                                        title="" data-toggle="tooltip" data-original-title="Edit"><i
                                            class="fas fa-pen"></i></a>
                                    <input type="hidden" name="list_id" value="{{ $buylist->id }}">
                                    <button type="submit" class="delete"
                                        style="background-color: transparent; border: none;" title=""
