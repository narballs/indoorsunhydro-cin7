...
@section('content')
    <div class="table-wrapper">
            ...
            <div class="col-sm-2 mb-5">
                <div class="search-box">
                    <a href="{{'order/create'}}"><input type="button" value="Create New Order" class="form-control btn btn-primary" placeholder="Create New">
                    </a>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/order-detail/'.$order->id) }}" class="view" title="" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
