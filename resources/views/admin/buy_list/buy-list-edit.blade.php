...
<div class="container">
    <div class="card">
        ...
        <div class="card-body table-responsive p-0">
                                ...
                                <td class="jsutify-content-middle">
                                  <!--   <small class="text-success mr-1">
                                    ...
                                    12%
                                      ...
                                      <input id="quantity_{{$list_product->product_id}}" type="number" value="{{$list_product->quantity}}" onchange="quantityChange({{$list_product->product->product_id}})">
                                </td>
            ...
            <i class="fas fa-trash-alt cursor-pointer" onclick="deleteProduct({{$list_product->product->product_id }})"></i>
        </a>
                                </td>
                            </tr>
                        @endforeach
