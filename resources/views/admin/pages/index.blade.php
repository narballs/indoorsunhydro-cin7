...
@section('content')
    ...
    <div class="table-wrapper">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 mobile_heading text-right">
                            <p class="product_heading">
                                <a class="btn btn-primary text-white" href="{{ route('pages.create') }}"> Create Page</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-body  mt-5">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('pages.destroy', $page->id) }}" method="POST" style="display: inline-block;">
                                    <a href="{{ route('pages.edit', $page->id) }}" class="btn btn-primary btn-sm text-white">Edit</a>
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="row">
                <div class="col-md-10">
                    {{ $pages->links('pagination.custom_pagination') }}
                </div>
            </div>
        </div>
    @stop
