...
<div class="row ">
    ...
    <div class="col-md-6 text-right">
        <a class="btn btn-primary text-white" href="{{ route('pages.index') }}">Back</a>
    </div>
</div>
@stop
                        ...
                        <div class="row justify-conntent-between">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" value="" id="banner_image" aria-describedby="" name="banner_image" accept="jpg,png,jpeg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group" id="">
                                    ...
                                    <textarea class="form-control" name="description" id="editor"> {{$page->description}}</textarea>
