        ...
        <div style="text-align:center"><h1>{{$list->title}}</h1></div>
            <table class="bordered" style="width:80%;margin:auto; border:1px solid #edf1f7;">
                ...
                <tbody>
                    ...
                    <tr class="has-bordered"><td colspan="5" style="text-align:left;margin-left: 20px"><h3><span style="margin-left:40px">Expire Date</span></h3></td><td><span style="margin-left:75px;text-align:center"><h3>{{!empty($list->shipping_and_discount) ? $list->shipping_and_discount->expiry_date : ''}}</h3></span></td></tr>
                    <tr class="has-bordered"><td colspan="5" style="text-align:left;margin-left: 20px"><h3><span style="margin-left:40px">Discount</span></h3></td><td><span style="margin-left:75px;text-align:center"><h3>{{!empty($list->shipping_and_discount) && $list->shipping_and_discount->discount_type == 'fixed' ? $discount_type : ''}}{{!empty($list->shipping_and_discount) ? number_format($list->shipping_and_discount->discount , 2) . $discount_type : 'Charged On Site'}}</h3></span></td></tr>
