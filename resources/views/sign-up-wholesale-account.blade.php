    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-0 pr-0">
        ...
        <div class="row ml-0 pr-0 w-100 main_image_mbl" style="background-image: url('/theme/img/img_12.png');">
            <div class="login-reg-panel col-xs-6">
                ...
                <div class="register-info-box text-center d-none">
                ...
                @endif
                <div class="white-panel right-log" style="box-shadow: 0 0 0 0 !important;" id="main-white-panel">
                    ...
                    <div class="register-show" style="margin-top: 56px;" id="register_first_step_wholesale">
                ...
                <div class="login-info-box text-white d-block" id="login_sidebar_wholesale">
                    <h2 class=" dont-have-an-account text-left">To become a wholesale customer, you need to register first.</h2>
                    <p class=" dont-have-an-account-pra text-left" id="account">Please finish the Sign Up process to start filling out your wholesale application.
                    </p>
                    {{-- <div class="d-flex justify-content-center">
                ...
                <div class="row company-row bg-light">
                    <div class="white-panel right-log d-none company-detail" id="company-detail"
                            ...
                            <div class="">
                                <form action="">
                                    ...
                                    <div class="row justify-content-center">
                                        {{-- <div class="col-md-10">
                                            <div class="row">
                                                <div class="col-md-12 company_name_required mt-3">
                                                    <input type="text"  placeholder="&#xf1ad; Company Name" id="company_name"
                                                        name="company_name" class="fontAwesome p-3 company-info sign-up-fields" required>
                    ...
                    <div class="white-panel right-log d-none" id="login-form-section" style="box-shadow: 0 0 0px 0px;">
                       <div class="mt-5 margin-adjust-mbl">
                ...
                <div class="row white-panel right-log bg-light d-none" id="business-row">
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.success == true) {
                    ...
                    $('#login-form-section').addClass('d-none');
                    $('#register_first_step_wholesale').addClass('d-none');
                    $('#main-white-panel').addClass('d-none');
                    $(".company-loc").hide();
                    $("#company-detail").removeClass('d-none');
                    $('#login_sidebar_wholesale').addClass('d-none');
                    $('#login_sidebar_wholesale').removeClass('d-block');
